...
class Rect(object):
    ...
    # Not sure why I'm supposed to trust this when the overlap parameters are hard-coded
    # although I think the overlap test is a cythonized function elsewhere
